...
import { Calculator, DollarSign, TrendingDown, TrendingUp, Percent } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-2">
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Monthly Transportation Deduction (ILS)
              </label>
              <p className="text-xs text-gray-500 mb-2 italic">
            ...
            <div className="pt-2">
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Yearly Education Deduction (ILS)
              </label>
            ...
            <div className="pt-2">
              ...
              <p className="text-xs text-gray-500 mb-2 italic">
                Post-tax deductions: insurance, loans, etc.
              </p>
              <input
                type="number"
                step="0.01"
